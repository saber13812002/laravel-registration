        ...
        <transition name="dropdown">
          <div class="dropdown__menu" v-bind:class="{ active: show }" v-if="show">
            <ul class="dropdown__menu-nav">
              ...
              <li class="dropdown__menu-item">
                <a href="/dashboard" class="dropdown__menu-link" title="Account">
                  <div class="dropdown__menu-svg">
                    <svg viewBox="0 0 496 512">
                      <path
                        fill="currentColor"
                  ...
                  <div class="dropdown__menu-text">داشبورد</div>
                </a>
              </li>
              <li class="dropdown__menu-item">
                <a href="/profile" class="dropdown__menu-link" title="Account">
                  ...
                  <div class="dropdown__menu-text">پروفایل</div>
                </a>
              </li>
              <li class="dropdown__menu-item">
                <a href="/profile" class="dropdown__menu-link" title="Personal info">
                  ...
                  <div class="dropdown__menu-text">اطلاعات فردی</div>
                </a>
              </li>
              <li class="dropdown__menu-item">
                <a href="#" class="dropdown__menu-link" title="People &amp; sharing">
                  ...
                  <div class="dropdown__menu-text">اشتراک برای دوستان</div>
                </a>
              </li>
              <!-- <li class="dropdown__menu-item">
                <a href="/team" class="dropdown__menu-link" title="Subscriptions">
                  <div class="dropdown__menu-svg">
                    <svg viewBox="0 0 576 512">
                      <path
                        fill="currentColor"
                  ...
                  <div class="dropdown__menu-text">تیم</div>
                </a>
              </li>
              <li class="dropdown__menu-item">
                <a href="/playgroundnew" class="dropdown__menu-link" title="Subscriptions">
                  <div class="dropdown__menu-svg">
                    <svg viewBox="0 0 576 512">
                      <path
                        fill="currentColor"
                  ...
                  <div class="dropdown__menu-text">اضافه کردن زمین</div>
                </a>
              </li>
              <li class="dropdown__menu-item">
                <a href="/playgroundlist" class="dropdown__menu-link" title="Subscriptions">
                  <div class="dropdown__menu-svg">
                    <svg viewBox="0 0 576 512">
                      <path
                        fill="currentColor"
                  ...
                  <div class="dropdown__menu-text">لیست زمین</div>
                </a>
              </li> -->
              ...
              <li class="dropdown__menu-item">
                <a href="#" class="dropdown__menu-link" title="Help">
                  ...
                  <div class="dropdown__menu-text">راهنما</div>
                </a>
              </li>
              <li class="dropdown__menu-item">
                <a href="#" class="dropdown__menu-link" title="Send feedback">
                  ...
                  <div class="dropdown__menu-text">ارسال بازخورد</div>
                </a>
              </li>
              ...
              <hr />
              <li class="dropdown__menu-item">
                <a href="/signout" class="dropdown__menu-link" title="Send feedback">
                  <div class="dropdown__menu-svg">
                    <svg viewBox="0 0 512 512">
                      <g>
                        <g>
			...
			C440.092,365.642,437.642,356.466,430.471,352.317z"
                  ...
                  <div class="dropdown__menu-text">خروج</div>
                </a>
              </li>
            </ul>
          </div>
