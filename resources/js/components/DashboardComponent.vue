    ...
    <div class="container-fluid display-table">
      <div class="row display-table-row">
        <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
          <div class="logo">
            <a hef="home.html">
              <img src="/assets/imgs/apple.png" alt="merkery_logo" class="hidden-xs hidden-sm" />
              <img
                src="/assets/imgs/apple.png"
                alt="merkery_logo"
            ...
            <ul>
              ...
              <li>
                <a href="#">
                  ...
                  <span class="hidden-xs hidden-sm">پیشنهادات</span>
                </a>
              </li>
              <li>
                <a href="#">
                  <i class="fa fa-bar-chart" aria-hidden="true"></i>
                  <span class="hidden-xs hidden-sm">آمار</span>
                </a>
              </li>
              <li>
                <a href="#">
              ...
              <li>
                <a href="#">
                  ...
                  <span class="hidden-xs hidden-sm">تنظیمات</span>
                </a>
              </li>
            </ul>
          </div>
                  ...
                  <ul class="list-inline header-top pull-right">
                      ...
                      <ul class="dropdown-menu">
                        <li>
                          <div class="navbar-content">
                            ...
                            <p class="text-muted small">ایمیل</p>
                            <div class="divider"></div>
                            <a href="#" class="view btn-sm active">مشاهده پروفایل</a>
                          </div>
                        </li>
                      </ul>
                    </li> -->
                    <li>
                      <a href="#" class="icon-info">
                        ...
                        <span class="label label-primary">3</span> پیام ها
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <i class="fa fa-envelope" aria-hidden="true"></i> ایمیل های ارسال شده
                      </a>
                    </li>
                    <li>
                      <a href="/profile">
                        <i class="fa fa-user" aria-hidden="true"></i> پروفایل
                      </a>
                    </li>
                    <li>
                      <a href="/signout">
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          <div class="modal-header login-header">
            ...
            <h4 class="modal-title">ویرایش پروفایل شما</h4>
          </div>
          ...
          <div class="modal-footer">
            <button type="button" class="cancel" data-dismiss="modal">بستن</button>
            <button type="button" class="add-project" data-dismiss="modal">ذخیره</button>
          </div>
        </div>
      </div>
    </div>
...
export default {
  data() {
    return {
      ...
      inviteText: "شما میتوانید از طریق دکمه های زیر ثبت نام کنید"
    };
  },
  mounted() {
  ...
  methods: {
    ...
    isLoggedIn() {
      if (localStorage.getItem("jwt")) {
        this.inviteText =
          "خوش آمدید با کلیک روی دکمه ی زیر به کارتابل خود بروید";
...
.user input {
  background: rgba(0, 0, 0, 0) url() no-repeat scroll 7px 12px;
}
...
.mail input {
  background: rgba(0, 0, 0, 0) url() no-repeat scroll 4px 12px;
}
...
.search input {
  ...
  padding: 15px 9px;
  width: 100%;
  background: rgba(0, 0, 0, 0) url() no-repeat scroll 99% 12px;
  color: #8492af;
}
