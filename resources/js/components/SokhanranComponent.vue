  ...
  <section id="works" class="works section no-padding">
    <div class="container-fluid">
      <div class="row no-gutter">
        ...
        <div class="container">
          <h3 class="text-center">Hover Effect Style : Demo - 1</h3>
          <div class="row mt-40">
            <div
              v-for="sokh in sokhanrans"
              :value="sokh.id"
              v-bind:key="sokh.id"
              class="col-md-4 col-sm-6"
            >
              <div class="box1">
                <img style="max-height:280px" v-bind:src="sokh.img" alt />
                <h3 class="title">{{sokh.name}}</h3>
                <ul class="icon">
                  <li>
                    <a href="/search">
        ...
        <div class="container mt-40">
          <h3 class="text-center">Hover Effect Style : Demo - 2</h3>
          <div class="row mt-30">
            <div
              v-for="sokh in sokhanrans"
              :value="sokh.id"
            ...
            >
              <div class="box2">
                <img style="max-height:280px" v-bind:src="sokh.img" />
                <div class="box-content">
                  <div class="inner-content">
                    <h3 class="title">{{sokh.name}}</h3>
                    <span class="post">{{sokh.family}}</span>
                    <ul class="icon">
                      <li>
                        <a href="/search">
                          <i class="fa fa-search"></i>
            ...
            >
              <div class="box3">
                ...
                <div class="box-content">
                  ...
                  <p
                    class="description"
                  >Lorem ipsum {{sokh.name}} Lorem {{sokh.family}} ipsum {{sokh.mobile}} Lorem ipsum.</p>
                  <ul class="icon">
                    <li>
                      <a href="/search" class="fa fa-search"></a>
                    </li>
                    <li>
                      <a v-bind:href="sokh.link" class="fa fa-link"></a>
                    </li>
                  </ul>
                </div>
                <p class="title">CEO & Founder, Example</p>
        ...
        <div class="container mt-40">
          <h3 class="text-center">Hover Effect Style : Demo - 4</h3>
          <div class="row mt-30">
            <div
              v-for="sokh in sokhanrans"
              :value="sokh.id"
        ...
        <div class="container mt-40">
          <h3 class="text-center">Hover Effect Style : Demo - 7</h3>
          <div class="row mt-30">
            <div
              v-for="sokh in sokhanrans"
              :value="sokh.id"
        ...
        <div class="container mt-40">
          <h3 class="text-center">Hover Effect Style : Demo - 13</h3>
          <div class="row mt-30">
            <div
              v-for="sokh in sokhanrans"
              :value="sokh.id"
        ...
        <div class="container mt-40">
          <h3 class="text-center">Hover Effect Style : Demo - 18</h3>
          <div class="row mt-30">
            <div
              v-for="sokh in sokhanrans"
              :value="sokh.id"
          ...
          <div class="row mt-30">
            ...
            >
              <div class="box21">
                <img style="max-height:280px" v-bind:src="sokh.img" alt />
                <div class="box-content">
                  <h4 class="title">{{sokh.family}}</h4>
                  <p
                    class="description"
                  >Lorem ipsum {{sokh.name}} Lorem {{sokh.family}} ipsum {{sokh.mobile}} Lorem ipsum.</p>
                  <a class="read-more" v-bind:href="sokh.link">رزومه کامل</a>
                </div>
              </div>
            </div>
          </div>
