    ...
    <div class="mainApp">
        ...
        <div class="page-wrapper">
            ...
            <div class="process-nav">
                <ul>
                    <li>
                        <a href="show.html" class="nav-item current">انتخاب بانک</a>
                    </li>
                    <li>
                        <a href="show-1.html" class="nav-item">انتخاب فرم</a>
                    </li>
                    <li>
                        <a href="show-2.html" class="nav-item">نمایش داده‌ها</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="tab-nav">
                <ul>
                    <li>
                        <a href="" class="nav-item active" persian>داده‌های شما (14)</a>
                    </li>
                    <li>
                        <a href="" class="nav-item" persian>سایر داده‌ها (5246)</a>
                    </li>
                </ul>
            </div>
                    ...
                    <table class="table table-line">
                        ...
                        <tbody>
                            <tr data-process="70">
                                <td class="has-img">
                                    <div class="image">
                                        <img src="https://fakeimg.pl/80x100/" />
                                    </div>
                                </td>
                                <td><b>تا ساحل آرامش</b></td>
                                <td><b>کتاب</b></td>
                                <td>محمدباقر کریمی</td>
                                <td>ارزیابی</td>
                                <td persian>1396/06/25</td>
                            </tr>
