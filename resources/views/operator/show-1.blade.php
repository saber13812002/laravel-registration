    ...
    <div class="mainApp">
        ...
        <div class="page-wrapper">
            ...
            <div class="process-nav">
                <ul>
                    <li>
                        <a href="show.html" class="nav-item passed">انتخاب بانک</a>
                    </li>
                    <li>
                        <a href="show-1.html" class="nav-item current">انتخاب فرم</a>
                    </li>
                    <li>
            ...
            <main class="main-pd container-fluid">
                <div class="main-title">
                    <div class="item title">
                        <i class="icon mz-inbox title-icon"></i>
                        <b>بانک کتاب من</b>
                        <small persian>254365 بازدید</small>
                ...
                <div class="banks-box block bank-change-view last-banks">
                    <div class="list-title">فرم‌های بانک کتاب</div>
                ...
                <div class="mt-5">
                    <div class="btn btn-white -showmore">
                        مشاهده همه فرم‌ها
                    </div>
                </div>
            </main>
