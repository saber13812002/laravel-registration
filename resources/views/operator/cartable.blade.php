    ...
    <div class="mainApp">
        ...
        <div class="page-wrapper">
            ...
            <div class="tab-nav">
                <ul>
                    <li>
                        <a href="" class="nav-item active" persian>در دست اقدام (14)</a>
                    </li>
                    <li>
                        <a href="" class="nav-item" persian>انجام شده (5246)</a>
                    </li>
                </ul>
            </div>
            ...
            <main class="main-pd container-fluid">
                <div class="main-title">
                    <div class="item mw-50 row">
                        <div class="col-6">
                            <select class="form-control" data-placeholder="انتخاب واحد">
                                <option selected>بانک</option>
                                <option>بانک کتاب</option>
