                    ...
                    <div class="form-group -md">
                        ...
                        <div class="upload-box row">
                            ...
                            <div class="info col-md-6">
                                توضیحاتی در مورد نوع فایل مثل فرمت rar و
                                سایز و یا حجم فایل لازم است اینجا نوشته شود.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="upload-box row">
                        <div class="col-md-6">
                            <div class="details-box">
                                ...
                                <div class="pinfo">
                                    <span class="spinner -sm"></span> درحال
                                    بارگذاری
                                </div>
                                <div class="details">
                                    <button type="button" class="btn btn-outline-dark btn-sm mw-6">
                                        لغو
                                    </button>
                                    <div class="file-details">
                                        <span class="icon"><i class="icon mz-file-empty"></i></span>
                                        <span class="name">4r-05-458409834709.rar</span>
                                        <span class="size">17.4 mb</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="upload-box row">
                        <div class="col-md-6">
                            <div class="details-box">
                                ...
                                <div class="pinfo text-success">
                                    <i class="icon mz-ok mr"></i> با موفقیت
                                    انجام شد
                                </div>
                                <div class="details">
                                    <button type="button" class="btn btn-outline-dark btn-sm mw-6">
