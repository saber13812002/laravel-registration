            ...
            <main class="main-pd container-fluid">
                <div class="main-title">
                    ...
                    <div class="item mw-50 row">
                        <div class="col-6">
                            <select class="form-control" data-placeholder="فیلتر فلان">
                                <option value=""></option>
                                <option>لورم</option>
                                <option>اپیسوم</option>
                            </select>
                        </div>
                        <div class="col-6">
                            <form class="search-form">
                ...
                <a class="box-link" href="#">
                    <div class="title">بچه های فنی و مهندسی</div>
                    <span persian>(145نفر)</span>
                    <i class="link-icon mz-left"></i>
                </a>
                <a class="box-link" href="#">
                    <div class="title">اهل محل</div>
                    <span persian>(2 نفر)</span>
                    <i class="link-icon mz-left"></i>
                </a>

                <div class="main-title -mt mb-3">
                    <b>بدون دسته بندی</b>
                </div>
                ...
                <div class="f-box">
                    <div class="avatar-box">
                        ...
                        <div class="details">
                            ...
                            <div class="info">ویژگی کاربر</div>
                        </div>
                    </div>
                    <div class="info">
                        هر توضیحی یا ویژگی دیگری که لازم است دیده شود.
                    </div>
                    <div class="btn-box">
                        <a href="#" class="text-gray">
                            <i class="icon mz-block"></i>
                        </a>
                        <a href="#" class="text-primary">
                            <i class="icon mz-notifications"></i>
                        </a>
                    </div>
