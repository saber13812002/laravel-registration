            ...
            <main class="main-pd container-fluid">
                ...
                <div class="f-box">
                    <div class="avatar-box">
                        ...
                        <div class="details">
                            <div class="name">
                                ارسال مدارک (عنوان یا موضوع)
                            </div>
                            <div class="info">نام کاربر</div>
                        </div>
                    </div>
                    <div class="info">
                        <span class="text-truncate">سلام وقتتون بخیر، ما مدارک را یک بار ارسال
                            ...</span>
                        <br />
                        <div class="span-box">
                            <span persian>95/11/27</span>
                            <span persian>18:12:24</span>
                            <span class="text-primary">ID:65695498746</span>
                        </div>
                    </div>
                    ...
                    <div class="btn-box">
                        <a href="#" class="text-gray">
                            <i class="icon mz-flag"></i>
                        </a>
                        <a href="#" class="text-gray">
                            <i class="icon mz-inbox"></i>
                        </a>
                        <a href="#" class="text-gray">
                            <i class="icon mz-trash-o"></i>
                        </a>
                    </div>
                </div>
                <div class="f-box">
