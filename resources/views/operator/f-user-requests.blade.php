            ...
            <main class="main-pd container-fluid">
                ...
                <div class="f-box">
                    ...
                    <div class="info">
                        <a href="#">سعید رضایی</a>،
                        <a href="#">حامد طالبی</a>،
                        <a href="#">کاظم طالبی</a> و
                        <a href="#">7 نفر</a> دیگر دنبال می کنند.
                    </div>
                    <div class="btn-box">
                    ...
                    <button class="btn btn-sm btn-outline-gray round">
                        رد درخواست
                    </button>
                    <button class="btn btn-sm btn-outline-primary round">
                        قبول درخواست
                    </button>
                </div>
                <div class="f-box">
