...
<body>
    <div class="mainApp">
        ...
        <div class="page-wrapper">
            ...
            <div class="main-btns main-pd container-fluid">
                <a href="add-taxonomy.html" class="btn btn-white"><i class="icon mz-list"></i><span>ثبت موضوع</span></a>
                <div class="btn btn-white">
                    <i class="icon mz-link"></i><span>ثبت رابطه</span>
                </div>
                <div class="btn btn-white">
                    <i class="icon mz-merge"></i><span>ادغام</span>
                </div>
            </div>
            ...
            <main class="main-pd container-fluid">
                <div class="main-title">
                    <div class="item grow row">
                        <div class="col">
                            <select class="form-control" data-placeholder="فیلتر علوم">
                                <option></option>
                                <option>علم 1</option>
                                <option>علم 2</option>
                            </select>
                        ...
                        <div class="col">
                            <select class="form-control" data-placeholder="فیلتر سامانه">
                                <option></option>
                                <option>سامانه 1</option>
                                <option>سامانه 2</option>
                            </select>
                        </div>
                        <div class="col">
                            <select class="form-control" data-placeholder="فیلتر جنسیت">
                                <option></option>
                                <option>مرد</option>
                                <option>زن</option>
                            </select>
                ...
                <div class="table-responsive">
                    <table class="table table-line">
                        ...
                        <tbody>
                            <tr>
                                <td><b>خانواده</b></td>
                                <td>اجتماعی، روانشناسی</td>
                                <td>توت فرنگی، گلابی</td>
                                <td>
                                    <span class="text-truncate">دوست، صله رحم، اقوام،خواب، آغوش
                                        مادر</span>
                                </td>
                            </tr>
                ...
                <div class="text-center box -trans">
                    <a href="#" class="btn btn-primary mw-10">بیشتر</a>
                </div>
            </main>
