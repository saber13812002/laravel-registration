        ...
        <div class="page-wrapper">
            ...
            <div class="process-nav">
                <ul>
                    ...
                    <li>
                        <a href="import-3.html" class="nav-item current">ثبت تفصیلی</a>
                    </li>
                    <li>
                ...
                <form>
                    ...
                    <div class="box">
                        <div class="form-group row -md">
                            <div class="col-sm-2 form-label">مقدمه</div>
                            <div class="col-sm-10">
                                <textarea class="form-control" rows="6" placeholder="اینجا بنویسید"></textarea>
                            </div>
                            <div>
                                <button type="button" class="btn btn-light-blue btn-sm">
                                    افزودن فایل
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="box">
                        <div class="form-group row -md">
                            <div class="col-sm-2 form-label">پیشگفتار</div>
                            <div class="col-sm-10">
                                <textarea class="form-control" rows="6" placeholder="اینجا بنویسید"></textarea>
                            </div>
                            <div>
                    ...
                    <div class="box">
                        <div class="form-group row -md">
                            <div class="col-sm-2 form-label">خلاصه</div>
                            <div class="col-sm-10">
                                <textarea class="form-control" rows="6" placeholder="اینجا بنویسید"></textarea>
                            </div>
                        </div>
                    ...
                    <div class="box">
                        <div class="form-group row -md">
                            <div class="col-sm-2 form-label">متن کامل</div>
                            <div class="col-sm-10">
                                <textarea class="form-control" rows="6" placeholder="اینجا بنویسید"></textarea>
                            </div>
                        </div>
                    ...
                    <div class="box">
                        ...
                        <div class="form-group row -md">
                            <div class="col-sm-2 form-label">دانشگاه</div>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" />
                            </div>
                        </div>
                    ...
                    <div class="box -btns">
                        <div class="item">
                            <a href="import-3.html" class="text-black imr"><i class="icon mz-arrow-right"></i>بازگشت</a>
                        </div>
                        <div class="item">
                            <div class="btn-box">
                                <a class="btn btn-warning" href="#">پیش‌نمایش</a>
                                <a class="btn btn-primary" href="#">ثبت و ورود جدید</a>
                                <a class="btn btn-black" href="import-4.html">ادامه</a>
                            </div>
                        </div>
                    </div>
                </form>
