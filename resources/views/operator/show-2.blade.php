        ...
        <div class="page-wrapper">
            ...
            <div class="process-nav">
                <ul>
                    ...
                    <li>
                        <a href="show-1.html" class="nav-item passed">انتخاب فرم</a>
                    </li>
                    <li>
                        <a href="show-2.html" class="nav-item current">نمایش داده‌ها</a>
                    </li>
                </ul>
            </div>
            ...
            <main class="main-pd container-fluid">
                <div class="breadcrumb-title">
                    <ul>
                        <li>
                            <i class="icon mz-inbox"></i><b>بانک کتاب من</b>
                        </li>
                        <li>فرم ثبت اجمالی</li>
                    </ul>
                </div>
                <div class="main-title">
                    <div class="item grow row">
                        <div class="col-6">
                            <select class="form-control" data-placeholder="انتخاب واحد">
                                <option selected>بانک کتاب</option>
                                <option>بانک نشریات</option>
                            </select>
                        </div>
                        <div class="col-6">
                            <select class="form-control" data-placeholder="انتخاب واحد">
                                <option>فرم ثبت</option>
                                <option>فرم ارزیابی</option>
                            </select>
                        </div>
                    </div>
                    <div class="item">
                        ...
                        <div class="btn-box" data-toggle="change-view" data-target=".datasets-box.change-view">
            ...
            <main class="pt-0 main-pd container-fluid has-sidebar">
                    ...
                    <div class="filters">
                        ...
                        <div class="checkbox-ui column">
                            <label>
                                <input type="checkbox" />
                                <i class="icon mz-checkbox"></i>
                                <span><i class="icon rl-music-note"></i> صوت
                                </span>
                            </label>
                            <label>
                                <input type="checkbox" />
                                <i class="icon mz-checkbox"></i>
                                <span><i class="icon rl-play-arrow"></i> فیلم
                                </span>
                            </label>
                            <label>
                                <input type="checkbox" />
                                <i class="icon mz-checkbox"></i>
                                <span><i class="icon rl-chart"></i> داده نما
                                </span>
                            </label>
                            <label>
                                <input type="checkbox" />
                                <i class="icon mz-checkbox"></i>
                                <span><i class="icon rl-attach"></i> فایل
                                </span>
                            </label>
                            <label class="more">
                ...
                <div class="main-wrapper">
                    <div class="datasets-box block change-view">
                        <div class="dataset">
                            <div class="progress">
