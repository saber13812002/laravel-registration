        ...
        <div class="page-wrapper">
            ...
            <main class="main-pd container-fluid">
                <div class="main-title -center">
                    <b>پیشنهاد ثبت بانک جدید</b>
                    <span class="info text-primary">لطفا اطلاعات لازم را در بخش‌های زیر پر کنید. ما
                        پیشنهاد شما را در اولین فرصت بررسی و ترتیب اثر
                        خواهیم داد.</span>
                </div>
                ...
                <form>
                    <div class="box">
                        <div class="form-group -md">
                            ...
                            <input class="form-control" placeholder="اینجا بنویسید" />
                        </div>
                        <div class="form-group -md">
                            <label>توضیحات<small persian>(درکمتر از 150 حرف معرفی کنید.)</small></label>
                    ...
                    <div class="box -btns">
                        <div class="item">
                            <div class="btn-box">
                                <a href="index.html" class="btn btn-light-d">بازگشت به پیشخوان</a>
                            </div>
                        </div>
                        <div class="item">
                            <div class="btn-box">
