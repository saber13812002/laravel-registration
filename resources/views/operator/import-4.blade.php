        ...
        <div class="page-wrapper">
            ...
            <div class="process-nav">
                <ul>
                    ...
                    <li>
                        <a href="import-2.html" class="nav-item passed">ثبت اجمالی</a>
                    </li>
                    <li>
                        <a href="import-3.html" class="nav-item passed">ثبت تفصیلی</a>
                    </li>
                    <li>
                        <a href="import-4.html" class="nav-item current">ارزیابی اولیه</a>
                    </li>
                    <li>
            ...
            <main class="main-pd container-fluid">
                <div class="box npx">
                    <div class="box-header text-center">
                        <span class="title -primary">ورود و ثبت اطلاعات با موفقیت به پایان
                            رسید</span>
                    </div>
                    <div class="box-body text-center">
                        <div class="-bold">
                            به زودی اطلاعات ارسالی شما بررسی، داوری و در
                            صورت ممکن منتشر خواهد شد.
                        </div>
                        <div class="mt-3 -bold">
                            شناسه اطلاعات شما:
                            <span class="text-primary" persian>34601687</span>
                        </div>
                        <div class="mt-5 mb-3 -bold">
                            نسخه پیش نمایش اطلاعات شما در لینک زیر قابل
                            مشاهده است
                        </div>
                        <a href="#" class="btn btn-primary mw-14">نسخه پیش نمایش</a>

                        <div class="-bold mt-5">
                            در صورت هر گونه اختلال با بخش پشتیبانی تماس
                            بگیرید
                        </div>
                        <div class="mt-3 content-info-box">
                            <div>
                                <i class="icon mz-phone pink-l"></i><span persian>0518787878</span>
                            </div>
                            <div>
                                <i class="icon mz-message orange-l"></i><span persian>3008</span>
                            </div>
                            <div>
                                <i class="icon mz-at"></i><a href="mailto:info@mizan.ir">info@mizan.ir</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="box bg-warning text-center">
                    <a class="btn btn-outline-white mw-14 itext" href="#"><i class="icon mz-folder-plus-o"></i><b>ثبت
                            اطلاعات جدید</b></a>
                </div>
            </main>
