...
<body>
    <div class="mainApp">
        ...
        <div class="page-wrapper">
            ...
            <div class="dashboard-intro main-pd">
                <div class="container-fluid">
                    <div class="text-center mb-5 text-lg">
                        <h5><b>به شبکه اطلاعات میزان خوش آمدید :)</b></h5>
                    </div>
                    <form>
                        <div class="input-group-box -lg search-box">
                    ...
                    <div class="btn-box">
                        <a href="#" class="btn btn-outline-white"><i class="icon mz-folder-plus-o"></i>
                            <b>ثبت اطلاعات</b></a>
                        <a href="#" class="btn btn-outline-white"><i class="icon mz-user-c"></i>
                            <b>ثبت پدیدآورنده</b></a>
                        <a href="#" class="btn btn-outline-white"><i class="icon mz-list"></i>
                            <b>ثبت موضوعات</b></a>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-line">
                        ...
                        <tbody>
                            <tr data-process="70">
                                ...
                                <td persian>10:36 - 1396/06/25</td>
                                <td class="text-center" persian>457</td>
                                <td class="text-center" persian>4</td>
                            </tr>
