            ...
            <main class="main-pd container-fluid">
                <div class="main-title -center">
                    <div class="item title">
                        <i class="icon mz-list"></i><b>ثبت موضوع</b>
                    </div>
                </div>
                ...
                <form>
                    <div class="box">
                        ...
                        <div class="form-group row -md">
                            <label class="col-sm-2 form-label">متا</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="اینجا بنویسید" />
                            </div>
                        </div>
                        <div class="text-left">
                            <div class="btn btn-sm btn-light-blue mw-8">
                                افزودن متا
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box">
                        <div class="box-title">انتخاب علوم مرتبط</div>
                        <div class="row">
                            <div class="col-3">
                                <div class="checkbox-ui column mt-3">
                                    <label>
                                        <input type="checkbox" value="" />
                                        <i class="icon mz-checkbox"></i>
                                        <span><b>عنوان اصلی علوم</b></span>
                                    </label>
                                    <label>
                                        <input type="checkbox" value="" />
                                        <i class="icon mz-checkbox"></i>
                                        <span>زیر عنوان علوم</span> </label><label>
                                        <input type="checkbox" value="" />
                                        <i class="icon mz-checkbox"></i>
                                        <span>زیر عنوان علوم</span> </label><label>
                                        <input type="checkbox" value="" />
                    ...
                    <div class="box">
                        <div class="box-title">انتخاب سامانه</div>
                        <div class="checkbox-ui">
                            <label>
                                <input type="checkbox" value="" />
                                <i class="icon mz-checkbox"></i>
                                <span>سیب</span> </label><label>
                                <input type="checkbox" value="" />
                                <i class="icon mz-checkbox"></i>
                                <span>پرتقال</span> </label><label>
                                <input type="checkbox" value="" />
                                <i class="icon mz-checkbox"></i>
                                <span>توت فرنگی</span> </label><label>
                                <input type="checkbox" value="" />
                                <i class="icon mz-checkbox"></i>
                                <span>آناناس</span> </label><label>
                                <input type="checkbox" value="" />
                                <i class="icon mz-checkbox"></i>
                                <span>موز</span>
                            </label>
                    ...
                    <div class="box">
                        <div class="box-title">مخاطب</div>
                        <div class="form-group row -md">
                            <label class="col-sm-2 form-label">بازه سنی</label>
                            <div class="col-sm-5">
                                <div class="input-group-box">
                                    <div class="input-group-text-addon">
                                        از
                                    </div>
                                    <input type="text" class="form-control" placeholder="_ _" />
                                    <div class="input-group-text-addon">
                                        سالگی
                                    </div>
                                </div>
                        ...
                        <div class="form-group row -md">
                            <label class="col-sm-2 form-label">جنسیت</label>
                            <div class="col-sm-10">
                                <select class="form-control" data-placeholder="انتخاب کنید">
                                    <option value=""></option>
                                    <option>مرد</option>
                                    <option>زن</option>
                                </select>
                        ...
                        <div class="form-group row -md">
                            <label class="col-sm-2 form-label">تاهل</label>
                            <div class="col-sm-10">
                                <select class="form-control" data-placeholder="انتخاب کنید">
                                    <option value=""></option>
                                    <option>مجرد</option>
                    ...
                    <div class="box">
                        <div class="box-title">نمایش در گراف</div>
                        <div class="form-group row -md">
                            <label class="col-sm-2 form-label">آیکون</label>
                            <div class="col-sm-10 upload-box">
                                <label class="upload">
                                    <input type="file" />
                                    <span class="file-control btn btn-primary btn"><i
                                            class="icon mz-cloud-upload-o"></i>
                                        افزودن</span>
                                </label>
                            </div>
                        </div>
                        <div class="form-group row -md">
                            <label class="col-sm-2 form-label">شکل</label>
                            <div class="col-sm-10">
                                <select class="form-control" data-placeholder="انتخاب کنید">
                                    <option value=""></option>
                                    <option>مربع</option>
                        ...
                        <div class="form-group row -md">
                            <label class="col-sm-2 form-label">اندازه</label>
                            <div class="col-sm-10">
                                <select class="form-control" data-placeholder="انتخاب کنید">
                                    <option value=""></option>
                                    <option>کوچک</option>
                    ...
                    <div class="box -btns">
                        <div class="btn-box mr-auto">
                            <a class="btn btn-primary" href="#">ثبت</a>
                        </div>
                    </div>
                </form>
            </main>
