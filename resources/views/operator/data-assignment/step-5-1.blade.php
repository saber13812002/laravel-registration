...
<body>
    <div class="mainApp">
        ...
        <div class="page-wrapper">
            ...
            <div class="process-nav">
                <ul>
                    <li>
                        <a href="step-1.html" class="nav-item passed">من کیم؟</a>
                    </li>
                    <li>
                        <a href="step-2.html" class="nav-item passed">چه خروجی هایی؟</a>
                    </li>
                    <li>
                        <a href="step-3.html" class="nav-item passed">در چه موضوعاتی؟</a>
                    </li>
                    <li>
                        <a href="step-4.html" class="nav-item passed">در چه گستره ای؟</a>
                    </li>
                    <li>
                        <a href="step-5.html" class="nav-item current">نمایش اطلاعات پیشنهادی</a>
                    </li>
                    <li>
                        <a href="step-6.html" class="nav-item">تمام انتخاب های شما</a>
                    </li>
                    <li>
                        <a href="step-7.html" class="nav-item">بررسی کارشناسی</a>
                    </li>
                </ul>
            </div>
            ...
            <main class="main-pd container-fluid">
                <div class="box box-info">
                    <div class="box-text">
                        شما وارد بانک کتاب شده اید. لطفا ضمن بررسی دقیق نسبت
                        به داده ها اظهار نظر نمایید.
                    </div>
                </div>

                <div class="row">
                    <div class="col-sm-2">
                        <div class="box npx -trans pt-0 pb-0">
                            <div class="datasets-carousel min">
                                <a class="btn btn-white	mb-2 btn-sm">همه بانک ها</a>
                                <div class="owl-carousel" data-items="1">
                                    <div class="banks-box block mt-0">
                                        <div class="bank">
                                            <div class="f">
                                                <div class="icon">
                    ...
                    <div class="col-sm-10">
                        <div class="box npx">
                            <div class="one-slider">
                                ...
                                <div class="box-header npx">
                                    <div class="avatar xl">
                                        <img src="../../img/avatar.jpeg" />
                                    </div>
                                    <div class="content">
                                        <div class="title -primary">
                                            نام فرد یا عنوان اثر
                                        </div>
                                        <div class="subtitle">
                                            اطلاعات دیگر
                                        </div>
                                    ...
                                    <div class="item">
                                        <div class="btn-box">
                                            <a href="#" class="btn btn-black btn-sm">این داده مربوط به من
                                                نیست</a>
                                            <a href="#" class="btn btn-warning btn-sm" data-toggle="dropdown">فردی را
                                                مرتبط با این داده
                                                می شناسم</a>
                                            <a href="#" class="btn btn-primary btn-sm" data-toggle="modal"
                                                data-target=".its-mine">این داده مرتبط با من است</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <hr />
                            <div class="box-body">
                                <small class="text-color" persian>رکورد 50 از مجموع 345 رکورد</small>
                                <div class="progress">
                                    <div class="progress-bar" role="progressbar" style="width: 14.4%;"
                                        aria-valuenow="14.4" aria-valuemin="0" aria-valuemax="100" persian>
                                        14.4%
                                    </div>
                                </div>
                            </div>
                ...
                <div class="box -btns">
                    <div class="item">
                        <a href="step-5.html" class="text-black imr"><i class="icon mz-arrow-right"></i>بازگشت</a>
                    </div>
                    <div class="item">
                        <div class="btn-box">
                            <a class="btn btn-outline-primary" href="step-6.html">رد کردن و نمایش داده های انتخابی</a>
                        </div>
                    </div>
                </div>
            </main>
    ...
    <div class="modal fade its-mine" tabindex="-1" role="dialog" aria-hidden="true">
