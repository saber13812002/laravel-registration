    ...
    <div class="mainApp">
        ...
        <div class="page-wrapper">
            ...
            <div class="process-nav">
                <ul>
                    <li>
                        <a href="step-1.html" class="nav-item current">من کیم؟</a>
                    </li>
                    <li>
                        <a href="step-2.html" class="nav-item">چه خروجی هایی؟</a>
                    </li>
                    <li>
            ...
            <main class="main-pd container-fluid">
                <div class="box box-info">
                    <div class="box-text">
                        گزینه هایی مشابه نام شما / نام مجموعه شما در شبکه
                        اطلاعات موجود است . ما این گزینه ها را برای شما
                        نمایش می دهیم. در صورتی که یکی از گزینه ها خود شما
                        هستید، تایید بفرمایید. در صورتی که گزینه های
                        پیشنهادی را می شناسید به ما کمک کنید تا از ایشان نیز
                        دعوت کنیم.
                    </div>
                </div>
                <div class="box npx">
                    <div class="one-slider">
                        ...
                        <div class="box-header nb npx">
                            ...
                            <div class="content">
                                ...
                                <div class="subtitle">اطلاعات دیگر</div>
                            </div>
                            <div class="item">
                                <div class="btn-box">
                                    <a href="#" class="btn btn-black btn-sm">این شخص من نیستم!</a>
                                    <a href="#" class="btn btn-warning btn-sm">من این شخص را می شناسم!</a>
                                    <a href="#" class="btn btn-primary btn-sm">خود من است! تایید میکنم</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="box -btns">
                    <div class="btn-box mr-auto">
                        <a class="btn btn-primary" href="step-2.html">مرحله بعد</a>
                    </div>
                </div>
            </main>
