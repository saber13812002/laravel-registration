        ...
        <div class="page-wrapper">
            ...
            <div class="process-nav">
                <ul>
                    ...
                    <li>
                        <a href="step-5.html" class="nav-item passed">نمایش اطلاعات پیشنهادی</a>
                    </li>
                    <li>
                        <a href="step-6.html" class="nav-item passed">تمام انتخاب های شما</a>
                    </li>
                    <li>
                        <a href="step-7.html" class="nav-item current">بررسی کارشناسی</a>
                    </li>
                </ul>
            </div>
            ...
            <main class="main-pd container-fluid">
                <div class="box npx">
                    <div class="box-header text-center">
                        <span class="title -primary">اطلاعات شما دریافت شد</span>
                    </div>
                    <div class="box-body">
                        <div class="-bold" persian>
                            ضمن تشکر از شما ، داده های انتخاب شده توسط شما
                            جهت بررسی کارشناسی به کارشناسان ارجاع می شود و
                            ظرف مدت 48 ساعت آتی پاسخ از همین طریق ارائه می
                            شود.
                        </div>

                        <div class="space -md"></div>
                        <div class="stats-list mr-auto ml-auto" style="max-width: 25rem">
                            <div class="item">
                                <div class="title">
                                    <i class="icon mz-user"></i>بانک کتاب
                                </div>
                                <div class="value" persian="">5 رکورد</div>
                            </div>
                            <div class="item">
                                <div class="title">
                                    <i class="icon mz-cube"></i>بانک مقالات
                                </div>
                                <div class="value" persian="">12 رکورد</div>
                            </div>
                            <div class="item">
                                <div class="title">
                                    <i class="icon mz-time"></i>بانک
                                    اختراعات
                                </div>
                                <div class="value" persian="">1 رکورد</div>
                            </div>
                            <div class="item">
                                <div class="title">
                                    <i class="icon mz-file-text"></i>بانک
                                    جلسات
                                </div>
                                <div class="value" persian="">15 رکورد</div>
                            </div>
                            <div class="item">
                                <div class="title">
                                    <i class="icon mz-location"></i>بانک
                                    پروژه های ساختمانی
                                </div>
                                <div class="value" persian="">2 رکورد</div>
                            </div>
                        </div>
                    </div>
                </div>
