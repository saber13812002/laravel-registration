        ...
        <div class="page-wrapper">
            ...
            <div class="process-nav">
                <ul>
                    ...
                    <li>
                        <a href="step-2.html" class="nav-item current">چه خروجی هایی؟</a>
                    </li>
                    <li>
                        <a href="step-3.html" class="nav-item">در چه موضوعاتی؟</a>
                    </li>
                    <li>
                        <a href="step-4.html" class="nav-item">در چه گستره ای؟</a>
                    </li>
                    <li>
                        <a href="step-5.html" class="nav-item">نمایش اطلاعات پیشنهادی</a>
                    </li>
                    <li>
            ...
            <main class="main-pd container-fluid">
                <div class="box box-info">
                    <div class="box-text">
                        خروجی های مختلف در قالب بانک های اطلاعاتی در آی ساخت
                        ایجاد شده است . شما می توانید با انتخاب بانک های
                        مرتبط با فعالیت خودتان نسبت به وجود داده های احتمالی
                        بررسی کنید.
                    </div>
                </div>
                ...
                <div class="box -btns">
                    <div class="btn-box mr-auto">
                        <a class="btn btn-primary" href="step-3.html">مرحله بعد</a>
                    </div>
                </div>
            </main>
