        ...
        <div class="page-wrapper">
            ...
            <main class="main-pd container-fluid">
                <div class="box box-info">
                    <div class="box-text">
                        بر اساس بررسی های صورت گرفته، فهرست داده های تخمینی
                        در هر یک از بانک ها به شرح زیر تقدیم می شود. لطفا با
                        کلیک کردن روی هر بانک و مشاهده داده ، نسبت به
                        ارزیابی و تایید یا رد داده ها اقدام نمایید.
                    </div>
                </div>

                <div class="banks-box block">
                    <div class="banks-list block">
                        <a href="step-5-1.html">
                            <div class="bank">
                                <div class="f">
                                    <div class="icon">
                                ...
                                <div class="b">
                                    <span persian>23 عدد از</span>
                                    <span persian>523403 رکورد</span>
                                </div>
                            </div>
                        </a>
