        ...
        <div class="page-wrapper">
            ...
            <div class="process-nav">
                <ul>
                    ...
                    <li>
                        <a href="step-3.html" class="nav-item current">در چه موضوعاتی؟</a>
                    </li>
                    <li>
            ...
            <main class="main-pd container-fluid">
                <div class="box box-info">
                    <div class="box-text">
                        عرصه ای که شما فعالیت می کنید محدود به یک دایره
                        واژگان و موضوعات تخصصی است . لطفا با انتخاب موضوعات
                        ما را در دسترسی راحت تر شما به اطلاعات مرتبط کمک
                        کنید.
                    </div>
                </div>
                ...
                <div class="main-title">
                    <div class="item">
                        <b>موضوعات مرتبط با درخواست خود را انتخاب کنید</b>
                    </div>
                    <div class="item">
                        <form class="search-form">
                ...
                <div class="box">
                    ...
                    <div class="box-title">انتخاب شما</div>
                    <div>
                        <span class="btn btn-warning btn-sm -in">
                            مردان
                            <i class="icon mz-close"></i>
                        </span>
                ...
                <div class="box -btns">
                    <div class="btn-box mr-auto">
                        <a class="btn btn-primary" href="step-4.html">مرحله بعد</a>
                    </div>
                </div>
            </main>
