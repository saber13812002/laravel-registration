        ...
        <div class="page-wrapper">
            ...
            <div class="process-nav">
                <ul>
                    ...
                    <li>
                        <a href="step-4.html" class="nav-item current">در چه گستره ای؟</a>
                    </li>
                    <li>
            ...
            <main class="main-pd container-fluid">
                <div class="box box-info">
                    <div class="box-text">
                        ممکن است خروجی ها و محصولات شما در یک گستره
                        جغرافیایی محدود و معین باشد. با انتخاب محدوده
                        جغرافیایی نسبت به ارائه هوشمندانه داده های مرتبط با
                        خود ، ما را یاری کنید.
                    </div>
                </div>
                ...
                <div class="box">
                    <div class="form-group row -md">
                        <div class="col-md-6">
                            <select class="form-control in-address" data-placeholder="کشور">
                                <option></option>
                                <option>ایران</option>
                                <option>عراق</option>
                                <option>ترکیه</option>
                        ...
                        <div class="col-md-6">
                            <select class="form-control in-address" data-placeholder="استان">
                                <option></option>
                                <option>تهران</option>
                                <option>قم</option>
                    ...
                    <div class="form-group row -md">
                        <div class="col-md-6">
                            <select class="form-control in-address" data-placeholder="شهر">
                                <option></option>
                                <option>قم</option>
                            </select>
                        </div>
                        <div class="col-md-6">
                            <select class="form-control in-address" data-placeholder="بخش و روستا">
                                <option></option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="box -btns">
                    <div class="btn-box mr-auto">
                        <a class="btn btn-primary" href="step-5.html">مرحله بعد</a>
                    </div>
                </div>
            </main>
