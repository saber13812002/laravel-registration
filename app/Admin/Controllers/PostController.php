...
class PostController extends AdminController
{
    ...
    protected function detail($id)
    {
        ...
        $show->tags('tags')->as(function ($tags) {
            return $tags->pluck('name');
        })->badge();

        $show->author('author', function ($author) {
            ...
            $author->avatar();
            $author->profile()->age();
            $author->profile()->gender('gender')->using(['m' => 'آقا', 'f' => 'آقا'], '未知');
        ...
        $show->comments('comments', function ($line) {
...
//        })->table();
    ...
    protected function form()
    {
        ...
        // $form->display('release_at', 'Created At');
        $form->display('updated_at', 'Updated At');
